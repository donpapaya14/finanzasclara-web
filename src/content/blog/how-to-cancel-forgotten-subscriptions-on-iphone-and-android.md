---
title: "How to cancel forgotten subscriptions on iPhone and Android"
description: "Discover the sneaky subscriptions draining your wallet and learn step-by-step how to cancel them on any device."
pubDate: 2026-05-13
category: "budgeting"
tags: ["cancel forgotten subscriptions on phone", "hidden subscription costs", "stop automatic payments", "find all my subscriptions", "subscription tracker app"]
author: "Vladys Z."
readingTime: 5
image: "https://images.pexels.com/photos/7430716/pexels-photo-7430716.jpeg?auto=compress&cs=tinysrgb&h=350"
imageAlt: "Minimalist flatlay featuring a smartphone with a subscribe screen, surrounded by delicate dried flow"
sources:
  - "C+R Research (2022). Subscription Waste Report"
  - "Apple Support Documentation (2023)"
  - "Google Play Help (2023)"
  - "Consumer Financial Protection Bureau (2022)"
  - "FTC Complaint Database (2023)"
  - "PC Magazine (2023). App Review"
draft: false
---
...
Some companies use **dark pattern tactics** to make cancellation difficult. Here are some examples:
* **Hidden cancellation buttons**
* **Complex cancellation processes**
* **Misleading cancellation information**
To fight back, use template emails to force cancellation, as reported by the [FTC Complaint Database 2023](https://www.ftc.gov).

## Best Free Apps to Track Future Subscriptions
Here's a comparison of top apps to track future subscriptions:
| App | Pros | Cons |
| --- | --- | --- |
...
Yes, you can use a virtual credit card, such as the [ Privacy.com Virtual Credit Card en Amazon](https://www.amazon.com/s?k=+Privacy.com+Virtual+Credit+Card&tag=vds96-20)(https://www.amazon.com), to prevent unwanted charges. This can help you avoid **hidden subscription costs** and **unwanted charges**.
...
## Practical Summary
Here are some concrete action bullets to help you **cancel forgotten subscriptions on phone**:
* Review your bank and PayPal statements regularly to identify hidden subscription costs
* Use a subscription tracker app, such as **Rocket Money** or **Truebill**, to stay on top of your subscriptions
* Cancel unwanted subscriptions using the **Settings** > **[Your Name]** > **Subscriptions** path on your iPhone
* Use a virtual credit card, such as the [ Privacy.com Virtual Credit Card en Amazon](https://www.amazon.com/s?k=+Privacy.com+Virtual+Credit+Card&tag=vds96-20)(https://www.amazon.com), to prevent unwanted charges
* Stop automatic payments by canceling recurring payments on your bank or PayPal account
* Use a budgeting app, such as **Mint**, to stay on top of your finances
By following these steps, you can avoid **hidden subscription costs** and **unwanted charges** and take control of your finances.
