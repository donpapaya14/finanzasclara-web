---
title: "Dividend Investing in REITs"
description: "Generate passive income with high-yield REITs"
pubDate: 2026-05-21
category: "passive-income"
tags: ["REITs", "dividend investing", "passive income", "real estate", "high yield stocks", "tax strategies", "portfolio diversification", "beginner investing"]
author: "Vladys Z."
readingTime: 4
image: "https://images.pexels.com/photos/33785776/pexels-photo-33785776.jpeg?auto=compress&cs=tinysrgb&h=350"
imageAlt: "A smartphone showing an investment app with green growth indicators, surrounded by credit cards, US"
sources:
  - "National Association of Real Estate Investment Trusts (2022). REIT Performance Data"
  - "Yahoo Finance (2023). Dividend Stock Screeners"
  - "Investopedia (2020). Compound Interest Calculations"
  - "Journal of Real Estate Finance (2019). Risk Analysis in REITs"
  - "Internal Revenue Service (2022). Tax Code Publication 550"
  - "The Motley Fool (2022). REIT Investing Guide"
draft: false
---

## Introduction to REITs

Real Estate Investment Trusts (REITs) are companies that own, operate, or finance income-producing real estate. They offer investors a way to earn **passive income** through dividends without directly owning property. According to the [National Association of Real Estate Investment Trusts (2022)](https://www.reit.com), REITs have delivered an average annual return of **9.5%** over the past 20 years, outperforming the S&P 500 in certain periods.
...
> Relacionado: [Hidden Subscriptions Costing You Money](/blog/hidden-subscriptions-costing-you-money)

## Top High-Yield REITs for Beginners

Here are 5 high-yield REITs with strong track records, based on [Yahoo Finance (2023)](https://finance.yahoo.com) data:

| REIT | Ticker | Dividend Yield | 5-Year Dividend Growth |
|------|--------|----------------|------------------------|
| Realty Income | O | 5.2% | 3.1% |
| AGNC Investment | AGNC | 14.1% | -2.3% |
| W.P. Carey | WPC | 6.3% | 1.2% |
| Medical Properties Trust | MPW | 11.8% | 1.8% |
| Annaly Capital | NLY | 13.5% | -4.5% |

> Relacionado: [Zero-Based Budgeting Explained](/blog/zero-based-budgeting-explained)

**Beginner tip:** Focus on **equity REITs** like Realty Income with consistent payout histories rather than high-risk mortgage REITs.

## Dividend Compounding Example

A $10,000 investment in a REIT yielding 6% with dividends reinvested grows to **$17,908** in 10 years (assuming 3% annual appreciation). [Investopedia (2020)](https://www.investopedia.com) calculations show:
...
Key risks per the [Journal of Real Estate Finance (2019)](https://www.jrefjournal.com):
...
REIT dividends are taxed as **ordinary income**, not qualified dividends. The [Internal Revenue Service (2022)](https://www.irs.gov) rules:
...
Follow these steps from [The Motley Fool (2022)](https://www.fool.com):
...
For beginners, [Real Estate Investing For Dummies en Amazon](https://www.amazon.com/s?k=Real+Estate+Investing+For+Dummies&tag=vds96-20) provides excellent foundational knowledge.
...
I now allocate 15% of my portfolio to REITs, focusing on sectors with **recession-resistant** cash flows. For beginners, I recommend starting with [The Little Book of Common Sense Investing en Amazon](https://www.amazon.com/s?k=The+Little+Book+of+Common+Sense+Investing&tag=vds96-20) alongside REIT ETFs to balance risk.
...
7. Read [Real Estate Investing For Dummies en Amazon](https://www.amazon.com/s?k=Real+Estate+Investing+For+Dummies&tag=vds96-20) before stock picking
