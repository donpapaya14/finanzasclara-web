---
title: "Beginner's guide to investing in REITs for passive income"
description: "Learn how REITs work, their historical returns, risks, and how to start investing with as little as $100."
pubDate: 2026-05-22
category: "investing"
tags: ["investing in REITs for beginners", "REITs historical returns", "best REITs to buy", "REITs vs rewards", "how REITs pay dividends", "REITs minimum investment"]
author: "Vladys Z."
readingTime: 7
image: "https://images.pexels.com/photos/8919508/pexels-photo-8919508.jpeg?auto=compress&cs=tinysrgb&h=350"
imageAlt: "A tablet with text 'To Invest or To Sell?' on a white background."
sources:
...
Investing in REITs can be accessible to anyone, regardless of the amount of money they have to invest. With the rise of **fractional shares**, investors can buy a portion of a REIT with as little as **$100**. Popular REIT ETFs, such as [VNQ](https://www.vanguard.com/) and [SCHH](https://www.schwab.com/), offer a diversified portfolio of REITs and can be purchased through a brokerage account.

### Steps to buy your first REIT
1. Open a brokerage account with a reputable online broker, such as [Fidelity Investments](https://www.fidelity.com/).
2. Fund your account with at least **$100**.
3. Research and select a REIT or REIT ETF to invest in.
4. Place an order to buy the REIT or REIT ETF through your brokerage account.

## Tax implications of REIT investments
REITs are subject to unique tax rules, which can impact the after-tax returns of investors. **Ordinary income** and **qualified dividends** are two types of income that REITs can generate, and they are taxed differently. According to the [IRS](https://www.irs.gov/), REITs are required to provide investors with a **1099-DIV** form, which reports the amount of dividends and capital gains distributions.
...
Investing in REITs can provide a range of benefits, including **diversification**, **income generation**, and **potential for long-term growth**. According to a study by [NAREIT](https://www.nareit.com/), REITs have historically provided competitive returns and lower volatility compared to other asset classes.
...
REITs pay dividends to shareholders from the income they generate from their properties. According to the [IRS](https://www.irs.gov/), REITs are required to distribute at least **90%** of their taxable income to shareholders in the form of dividends.
